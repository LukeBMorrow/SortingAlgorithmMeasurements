...
public class Stats {
    ...
    public static boolean isSorted(int[] nums, String sortType)
    {
        ...
        { currentSortedIndex++; }//look for a place where the data is out of order
    ...
    {
        for(int currentFillingIndex:nums)//fills the array
        { nums[currentFillingIndex]=currentFillingIndex; }
